...
#include "../ff.h"
 ...
 //#error This file is not needed in current configuration. Remove from the project.    //exclude cc936.c
#endif
...
WCHAR ffxx_convert (	/* Converted code, 0 means conversion error */
...
WCHAR ffxx_wtoupper (	/* Upper converted character */
