...
#define MY_TIMER_CLK_EN   SYSCTL_PERIPH_CLK_TIMER4   //!< Timer peripheral clock enable
#define MY_TIMER_BASE     TIMER4_BASE   //!< Timer base
#define MY_TIMER_CHANNEL  0             //!< Timer channel number
#define MY_TIMER_IRQ      TIMER4_C1_IRQn
