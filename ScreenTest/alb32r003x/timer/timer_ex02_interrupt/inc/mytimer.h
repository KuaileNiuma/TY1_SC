...
#define MY_TIMER_CLK_EN   SYSCTL_PERIPH_CLK_TIMER2   //!< Timer peripheral clock enable
#define MY_TIMER_BASE     TIMER2_BASE   //!< Timer base
#define MY_TIMER_CHANNEL  0             //!< Timer channel number
#define MY_TIMER_IRQ      TIMER2_C1_IRQn
