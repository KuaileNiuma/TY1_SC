...
//
float idRef      = (0.4f);              // Id reference (pu)
float speedRef   = (0.5f);          // Speed reference (pu)
float T          = (SAMPLING_PERIOD); // Samping period (sec)
...
//
float	DLogCh1[DLOG_NUMBER_SAMPLES];
float	DLogCh2[DLOG_NUMBER_SAMPLES];
...
void ACI_main(void)
{
    ...
    aci1.K1 = (aci1Const.K1);
    aci1.K2 = (aci1Const.K2);
    aci1.K3 = (aci1Const.K3);
    aci1.K4 = (aci1Const.K4);
    aci1.K5 = (aci1Const.K5);
    aci1.K6 = (aci1Const.K6);
    aci1.K7 = (aci1Const.K7);
    aci1.K8 = (aci1Const.K8);
    aci1.K9 = (aci1Const.K9);
    aci1.K10 = (aci1Const.K10);
    aci1.base_rpm = 120.0f * BASE_FREQ / P_VALUE;
    aci1.load_torque = (TL_VALUE / BASE_TORQUE);
    ...
    fe1.K1_fe = (fe1Const.K1);
    fe1.K2_fe = (fe1Const.K2);
    fe1.K3_fe = (fe1Const.K3);
    fe1.K4_fe = (fe1Const.K4);
    fe1.K5_fe = (fe1Const.K5);
    fe1.K6_fe = (fe1Const.K6);
    fe1.K7_fe = (fe1Const.K7);
    fe1.K8_fe = (fe1Const.K8);
    fe1.Kp_fe = (0.055f);
    fe1.Ki_fe = (0.002f);
    ...
    se1.K1_se = (se1Const.K1);
    se1.K2_se = (se1Const.K2);
    se1.K3_se = (se1Const.K3);
    se1.K4_se = (se1Const.K4);
    se1.base_rpm_se = 120.0f * BASE_FREQ / P_VALUE;

    //
    // Initialize the PID_REG3 module for Id
    //
    pid1Id.Kp_reg3 = (0.0541f);
    pid1Id.Ki_reg3 = (0.5f);
    pid1Id.Kd_reg3 = (0.2f);
    pid1Id.Kc_reg3 = (0.1f);
    pid1Id.pid_out_max = (0.71f);
    pid1Id.pid_out_min = (-0.71f);

    //
    // Initialize the PID_REG3 module for Iq
    //
    pid1Iq.Kp_reg3 = (0.0541f);
    pid1Iq.Ki_reg3 = (0.5f);
    pid1Iq.Kd_reg3 = (0.2f);
    pid1Iq.Kc_reg3 = (0.1f);
    pid1Iq.pid_out_max = (0.71f);
    pid1Iq.pid_out_min = (-0.71f);

    //
    // Initialize the PID_REG3 module for speed
    //
    pid1Spd.Kp_reg3 = (7.2f);
    pid1Spd.Ki_reg3 = (0.05f);
    pid1Spd.Kd_reg3 = (0.2f);
    pid1Spd.Kc_reg3 = (0.9f);
    pid1Spd.pid_out_max = (1.0f);
    pid1Spd.pid_out_min = (-1.0f);
    ...
    printf("\r\n Motor Speed at end of test (expected 0.5) : %3f",
            speedEndOfTest);
...
void aci_ctrlLoop(void)
{
  ...
  //
  float ialpha = clarke1.Alpha;
  float ibeta = clarke1.Beta;
#else

  //
  // Apply ACI model derived phase current to park transform
  //
  float ialpha = aci1.ialfa;
  float ibeta = aci1.ibeta;
  ...
  uint32_t Ua = (PWM_HALF_MAX)*(svgen1.Ta)+ PWM_HALF_MAX;
  uint32_t Ub = (PWM_HALF_MAX)*(svgen1.Tb)+ PWM_HALF_MAX;
  uint32_t Uc = (PWM_HALF_MAX)*(svgen1.Tc)+ PWM_HALF_MAX;
  ...
  ++ctrlLoopCount;
    ...
    //
    if(ctrlLoopCount == DLOG_NUMBER_SAMPLES)
    {
        ADCInt_disable();
    }
    //
